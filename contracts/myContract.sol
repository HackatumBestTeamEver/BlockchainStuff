...
contract myContract is mortal {
	...
	uint public initialPolicyRatio; // 1000*User/Insurance
	...
	function buy() public payable
		...
		customerOnly(msg.sender) {
			...
			moneyInsurance = monthlyPolicyMax * initialPolicyRatio / 1000;
	...
	function updateScores(uint scoreStep) public carOnly(msg.sender) {
		require(insuranceState == 1);
		scores = (scores-scoreStep > 0 ? scores-scoreStep : 0);

		moneyCustomer = scores*monthlyPolicyMax*initialPolicyRatio/(1000*scoresMax);
